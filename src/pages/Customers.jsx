          ...
          {!customer ? (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div className="rounded-xl border border-slate-200/70 bg-white p-3.5">
                  <p className="text-[12.5px] font-semibold text-slate-600 mb-1">Total Paid</p>
                ...
                {/* Claimed, not received. Kept apart from Total Paid on
                ...
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
                    <tr className="bg-[#fbfcfd] border-b border-slate-100 text-[11.5px] font-bold uppercase tracking-[0.05em] text-slate-600">
                      ...
                      <th className="px-3 py-2.5 whitespace-nowrap text-right">Paid</th>
