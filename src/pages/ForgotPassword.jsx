        ...
        <div className="w-full max-w-[440px]">
          ...
          {!submitted ? (
            ...
            <>
              ...
              <h1 className="text-[clamp(28px,2.1vw,36px)] font-bold tracking-[-0.025em] text-slate-900">Check your email</h1>
              ...
              <button
                ...
                className={`w-full mt-[22px] py-3 rounded-[11px] border border-slate-300 bg-white text-[15px] font-semibold text-slate-700 transition-colors ${
